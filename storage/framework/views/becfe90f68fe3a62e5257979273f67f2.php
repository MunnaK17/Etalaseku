...
<head>
    ...
    <title><?php echo e(config('app.name', 'EtalaseKU')); ?> - <?php echo e($title ?? 'Auth'); ?></title>
...
<body class="selection:bg-[#e9c0e9] selection:text-[#432646] min-h-screen flex items-center justify-center p-4 md:p-10">
    ...
    <header class="absolute top-0 left-0 w-full flex justify-between items-center px-6 md:px-10 py-5 z-50">
        <a href="<?php echo e(url('/')); ?>" class="text-xl font-bold text-[#e5e2e1]">EtalaseKU</a>
        <a class="group flex items-center gap-2 bg-[#2a2a2a]/40 hover:bg-[#2a2a2a] py-2 px-5 rounded-full text-sm font-semibold text-[#e5e2e1] transition-all duration-300" href="<?php echo e(url('/')); ?>">
            Kembali ke website
...
</html><?php /**PATH C:\laragon\www\EtalaseKU\resources\views/layouts/guest.blade.php ENDPATH**/ ?>
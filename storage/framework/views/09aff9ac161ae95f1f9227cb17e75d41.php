...
<div class="py-6">
    <div class="settings-container">
        ...
        <div class="settings-header mb-6">
            <h1>Pengaturan</h1>
            <p>Kelola informasi dan pengaturan etalase <?php echo e($store->name); ?></p>
        </div>
        ...
        <div class="lynkid-bar">
            <div class="lynkid-info">
                ...
                <span class="lynkid-url"><?php echo e($store->public_url); ?></span>
            </div>
            <div class="lynkid-actions">
                <a href="<?php echo e($store->public_url); ?>" target="_blank" class="lynkid-btn lynkid-btn-primary">
        ...
        <div class="status-summary">
            <div class="status-summary-item">
                ...
                <div class="status-summary-value">
                    <span class="status-dot <?php echo e($isPro ? 'status-dot-green' : 'status-dot-gray'); ?>"></span>
                    <?php echo e($store->plan_display_name); ?>

                </div>
                <?php if($proExpiresAt): ?>
                    <p class="status-summary-note">Expired: <?php echo e($proExpiresAt); ?></p>
                <?php endif; ?>
            </div>
            ...
            <div class="status-summary-item">
                ...
                <div class="status-summary-value">
                    <span class="status-dot <?php echo e($store->isVerifiedSeller() ? 'status-dot-green' : 'status-dot-gray'); ?>"></span>
                    <?php echo e($store->isVerifiedSeller() ? 'Ya' : 'Tidak'); ?>

                </div>
                <?php if($store->verified_at): ?>
                    <p class="status-summary-note">Sejak <?php echo e($store->verified_at->timezone(config('app.timezone'))->format('d M Y')); ?></p>
                <?php endif; ?>
            </div>
            ...
            <div class="status-summary-item">
                ...
                <div class="status-summary-value">
                    <span class="status-dot <?php echo e($store->is_active ? 'status-dot-green' : 'status-dot-yellow'); ?>"></span>
                    <?php echo e($store->is_active ? 'Ya' : 'Tidak'); ?>

                </div>
                <p class="status-summary-note"><?php echo e($store->is_active ? 'Bisa dilihat publik' : 'Disembunyikan dari publik'); ?></p>
            </div>
            ...
            <button type="button" class="settings-card" onclick="openAccountModal()">
                <div class="settings-card-inner">
                    ...
                    <div>
                        ...
                        <p class="settings-card-meta"><?php echo e(auth()->user()->email); ?></p>
                    </div>
                </div>
            </button>
                ...
                <div class="settings-card-inner">
                    ...
                    <div>
                        ...
                        <p class="settings-card-meta">
                            <?php if($hasPayoutSettings): ?>
                                <?php echo e($store->payout_bank_name); ?> - <?php echo e($maskedPayoutAccount); ?>
                        ...
                        <div class="modal-form-grid">
                            <div class="form-group">
                                ...
                                <input type="password"
                                       ...
                                       class="form-input <?php echo e($errors->updatePassword->has('current_password') ? 'error' : ''); ?>"
                                       autocomplete="current-password"
                                       required>
                                <?php if($errors->updatePassword->has('current_password')): ?>
                                    <p class="form-error"><?php echo e($errors->updatePassword->first('current_password')); ?></p>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password"
                                       id="password"
                                       name="password"
                                       class="form-input <?php echo e($errors->updatePassword->has('password') ? 'error' : ''); ?>"
                                       autocomplete="new-password"
                                       required>
                                <?php if($errors->updatePassword->has('password')): ?>
                                    <p class="form-error"><?php echo e($errors->updatePassword->first('password')); ?></p>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password"
                                       ...
                                       class="form-input <?php echo e($errors->updatePassword->has('password_confirmation') ? 'error' : ''); ?>"
                                       autocomplete="new-password"
                                       required>
                                <?php if($errors->updatePassword->has('password_confirmation')): ?>
                                    <p class="form-error"><?php echo e($errors->updatePassword->first('password_confirmation')); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <div id="payoutModal" class="modal-backdrop" aria-hidden="true">
            <div class="settings-modal" role="dialog" aria-modal="true" aria-labelledby="payoutModalTitle">
                ...
                <form method="POST" action="<?php echo e(route('seller.store.update')); ?>">
                    ...
                    <input type="hidden" name="name" value="<?php echo e($store->name); ?>">
                    <input type="hidden" name="username" value="<?php echo e($store->username); ?>">
                        ...
                        <div class="modal-form-grid">
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       value="<?php echo e(old('payout_bank_name', $store->payout_bank_name)); ?>"
                                       class="form-input <?php $__errorArgs = ['payout_bank_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       required>
                                <?php $__errorArgs = ['payout_bank_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       value="<?php echo e(old('payout_account_number', $store->payout_account_number)); ?>"
                                       class="form-input <?php $__errorArgs = ['payout_account_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       required>
                                <?php $__errorArgs = ['payout_account_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       value="<?php echo e(old('payout_account_name', $store->payout_account_name)); ?>"
                                       class="form-input <?php $__errorArgs = ['payout_account_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       required>
                                <?php $__errorArgs = ['payout_account_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
        ...
        <div class="status-card">
            ...
            <div class="status-card-body">
                <div class="status-info">
                    ...
                    <p>Etalase saat ini <span class="<?php echo e($store->is_active ? '' : 'inactive'); ?>"><?php echo e($store->is_active ? 'sedang aktif' : 'sedang nonaktif'); ?></span></p>
                    <p>
                ...
                <form action="<?php echo e(route('seller.store.toggle-active')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="toggle-btn <?php echo e($store->is_active ? 'toggle-btn-active' : 'toggle-btn-inactive'); ?>">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<script>
    ...
    <?php if($errors->updatePassword->any() || session('status') === 'password-updated'): ?>
        openAccountModal();
    <?php endif; ?>

    <?php if(session('open_payout_modal') || $errors->has('payout_bank_name') || $errors->has('payout_account_number') || $errors->has('payout_account_name')): ?>
        openPayoutModal();
    <?php endif; ?>
</script>
<?php $__env->stopPush(); ?>

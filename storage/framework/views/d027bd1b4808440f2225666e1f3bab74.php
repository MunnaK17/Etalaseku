...
<body class="font-sans antialiased bg-gray-50 min-h-screen flex items-center justify-center">
    <div class="max-w-md mx-auto text-center px-4">
        ...
        <!-- Actions -->
        <div class="space-y-4">
            <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center justify-center gap-2 w-full py-3 px-6 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl transition-all">
        ...
        <div class="mt-8 p-4 bg-gray-100 rounded-lg text-left">
            <p class="text-xs text-gray-500 font-mono break-all">
                <strong>Exception:</strong> <?php echo e($exception->getMessage()); ?>
...
<?php /**PATH C:\laragon\www\EtalaseKU\resources\views/errors/404.blade.php ENDPATH**/ ?>
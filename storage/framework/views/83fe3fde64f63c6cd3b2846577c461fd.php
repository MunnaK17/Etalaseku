<?php $__env->startSection('title', 'QR Code - EtalaseKu'); ?>
<?php $__env->startSection('breadcrumb', 'QR Code'); ?>
...
<div class="py-6">
    <div class="qr-page-container">
        ...
        <div class="qr-header">
            ...
            <p>Generate dan download QR code untuk etalase <?php echo e($store->name); ?></p>
        </div>
                ...
                <div class="qr-card-body">
                    ...
                    <div class="qr-preview-container">
                        <div class="qr-preview-box">
                            <img id="qr-image" src="<?php echo e($storeUrl); ?>" alt="QR Code">
                        </div>
                        <p class="qr-preview-text">
                            Scan untuk membuka:<br>
                            <span><?php echo e($storeUrl); ?></span>
                        </p>
                    </div>
                    ...
                    <div class="qr-url-section">
                        ...
                        <div class="qr-url-input-group">
                            <input type="url" id="qr-url" value="<?php echo e($storeUrl); ?>"
                    ...
                    <div class="qr-card-body space-y-5">
                        ...
                        <div>
                            ...
                            <div class="qr-size-options">
                                <?php $__currentLoopData = [200, 300, 400, 500, 600]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="qr-size-option">
                                        <input type="radio" name="size" value="<?php echo e($size); ?>" class="sr-only"
                                               <?php echo e($size == 300 ? 'checked' : ''); ?>
...
<script>
    ...
    function downloadQr(format) {
        ...
        link.href = qrUrl;
        link.download = `qrcode-<?php echo e($store->username); ?>-${new Date().toISOString().slice(0,10)}.${format}`;
...
<?php echo $__env->make('layouts.seller', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\EtalaseKU\resources\views/seller/qr-code/index.blade.php ENDPATH**/ ?>
...
<body class="font-body-md selection:bg-surface-raised selection:text-primary-container">
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-8 py-4 bg-surface/80 backdrop-blur-md rounded-full mt-4 mx-auto w-[90%] max-w-7xl border border-border-dark transition-all duration-300">
        <a href="<?php echo e(url('/')); ?>" class="font-headline-lg-mobile text-headline-lg-mobile font-bold text-on-surface hover:text-surface-raised transition-colors">EtalaseKU</a>
        ...
        <div class="flex items-center gap-4">
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open"
                        ...
                        <div class="w-8 h-8 bg-surface-raised rounded-full flex items-center justify-center">
                            <span class="text-on-secondary text-sm font-semibold"><?php echo e(substr($user->name, 0, 1)); ?></span>
                        </div>
                    ...
                    <div x-show="open"
                        ...
                        <div class="px-4 py-3 border-b border-border-dark">
                            <p class="text-sm font-medium text-on-surface"><?php echo e($user->name); ?></p>
                            <p class="text-xs text-text-muted"><?php echo e($user->email); ?></p>
                        </div>
                        <a href="<?php echo e(route('seller.dashboard')); ?>" class="flex items-center gap-3 px-4 py-2 text-on-surface-variant hover:bg-surface-container-high hover:text-on-surface transition-colors">
                        ...
                        <?php if($store): ?>
                            <a href="<?php echo e($store->public_url); ?>" target="_blank" class="flex items-center gap-3 px-4 py-2 text-on-surface-variant hover:bg-surface-container-high hover:text-on-surface transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="hidden md:block font-label-md text-label-md text-on-surface hover:text-secondary transition-colors px-4 py-2">Log in</a>
                <a href="<?php echo e(route('register')); ?>" class="bg-surface-neutral text-primary-container px-6 py-3 rounded-full font-label-md text-label-md font-bold scale-95 active:scale-90 transition-transform hover:bg-surface-raised">Sign Up</a>
            <?php endif; ?>
        </div>
    </nav>
    ...
    <main>
        ...
        <section class="min-h-screen flex flex-col items-center justify-center pt-32 px-container-margin text-center">
            <div class="max-w-4xl space-y-stack-md">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-gutter pt-8">
                    <a href="<?php echo e(route('register')); ?>" class="bg-surface-raised text-primary-container px-12 py-6 rounded-full font-headline-lg-mobile text-headline-lg-mobile font-bold hover:opacity-90 transition-all scale-100 hover:scale-105 active:scale-95 shadow-xl shadow-surface-raised/20">
        ...
        <section id="harga" class="py-stack-lg px-container-margin max-w-5xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-stack-sm">
                ...
                <div class="bg-surface-container p-12 rounded-xl border border-border-dark flex flex-col justify-between">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="mt-12 w-full py-4 border-2 border-border-dark rounded-full font-bold hover:bg-surface-variant transition-colors text-center">
                        Pilih Free
                    </a>
                </div>
                <!-- Pro Plan -->
                <div class="bg-surface-raised p-12 rounded-xl flex flex-col justify-between shadow-2xl shadow-surface-raised/20 relative overflow-hidden">
                    ...
                    <a href="<?php echo e(route('register')); ?>?plan=pro" class="mt-12 w-full py-4 bg-primary-container text-on-primary rounded-full font-bold hover:opacity-90 transition-opacity text-center">
                        Pilih Pro
                    </a>
                </div>
            </div>
        ...
        <section class="py-stack-lg px-container-margin text-center">
            <div class="bg-gradient-to-b from-surface-container-high to-black rounded-xl p-20 border border-border-dark max-w-7xl mx-auto">
                ...
                <a href="<?php echo e(route('register')); ?>" class="bg-surface-neutral text-primary-container px-12 py-6 rounded-full font-headline-lg-mobile text-headline-lg-mobile font-bold hover:scale-105 active:scale-95 transition-transform inline-block">
                    Daftar Sekarang
                </a>
            </div>
        </section>
    ...
    <footer class="w-full py-stack-lg px-container-margin flex flex-col md:flex-row justify-between items-center gap-gutter bg-background border-t border-border-dark">
        <div class="flex flex-col items-center md:items-start gap-4">
            <a href="<?php echo e(url('/')); ?>" class="font-headline-lg text-headline-lg font-bold text-on-surface hover:text-surface-raised transition-colors">EtalaseKU</a>

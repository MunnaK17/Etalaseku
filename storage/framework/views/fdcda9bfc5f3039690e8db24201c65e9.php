...
<body class="no-transition antialiased">
    <div class="flex min-h-screen flex-col">
        <header class="flex shrink-0 items-center justify-between px-6 py-4 lg:px-12">
            <a href="<?php echo e($homeUrl); ?>" class="flex items-center gap-2 transition hover:opacity-90">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="<?php echo e($homeUrl); ?>" class="inline-flex items-center gap-1.5 rounded-md px-2 py-1 text-sm transition hover:opacity-80 focus-visible:outline-none focus-visible:ring-2" style="color: var(--text-muted); --tw-ring-color: var(--accent);">
        ...
        <main class="flex flex-1 flex-col items-center px-6 lg:flex-row lg:px-12">
            <section class="hidden items-center justify-center py-4 lg:flex lg:w-[55%]" aria-label="Ilustrasi setup etalase">
                <div class="flex max-h-[78vh] max-w-full items-center justify-center overflow-hidden rounded-2xl shadow-lg" style="background: var(--illustration-bg); aspect-ratio: 4 / 3">
                    <img src="<?php echo e(asset('images/register.png')); ?>" alt="Ilustrasi ekosistem EtalaseKu untuk membuat etalase" class="h-full w-full object-contain">
                </div>
            </section>
            ...
            <section class="flex w-full items-center justify-center py-8 lg:w-[45%] lg:py-0" aria-label="Form setup etalase">
                <div class="w-full max-w-[460px]">
                    ...
                    <form method="POST" action="<?php echo e(route('seller.onboarding.store')); ?>" class="space-y-5">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <div class="mt-1.5 flex rounded-lg shadow-sm">
                                ...
                                <input
                                    ...
                                    name="whatsapp"
                                    type="tel"
                                    value="<?php echo e($whatsappLocal); ?>"
                                    autocomplete="tel"
                                    inputmode="numeric"
...
<?php /**PATH C:\laragon\www\EtalaseKU\resources\views/seller/onboarding.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Dashboard - EtalaseKU'); ?>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-1 text-sm" style="color: var(--dashboard-text-muted);">
                        Halaman publik kamu:
                        <a href="<?php echo e(url('/' . $store->username)); ?>" target="_blank" class="font-medium" style="color: var(--accent);">
                            <?php echo e(url('/' . $store->username)); ?>
                ...
                <div class="blocks-container rounded-xl border p-4">
                    ...
                    <div class="flex flex-wrap gap-2" role="tablist">
                        ...
                        <div
                            ...
                            :class="currentPageId == <?php echo e($page->id); ?> ? 'text-black' : ''"
                            style="background-color: var(--dashboard-input-bg); color: var(--dashboard-text-muted);"
                            @click="switchPage(<?php echo e($page->id); ?>)"
                            role="tab"
                            :aria-selected="currentPageId == <?php echo e($page->id); ?>"
                        >
                            ...
                            <div class="flex items-center gap-1 ml-2">
                                <button @click.stop="openEditPageModal(<?php echo e($page->id); ?>, '<?php echo e($page->title); ?>', '<?php echo e($page->slug); ?>')" class="p-1 rounded transition" title="Edit Page" :style="'hover:bg-' + (currentPageId == <?php echo e($page->id); ?> ? 'yellow-400' : 'gray-700')">
                                ...
                                <?php if (! ($page->is_default)): ?>
                                <button @click.stop="openDeleteModal(<?php echo e($page->id); ?>, '<?php echo e($page->title); ?>')" class="p-1 rounded transition" title="Hapus Page" style="color: var(--danger);">
...
function blockDashboard() {
    return {
        currentPageId: <?php echo e($defaultPage->id); ?>,
        blocks: [],
        previewUrl: '<?php echo e(url('/' . $store->username)); ?>',
        previewKey: 0,
        isRefreshing: false,
        isSubmitting: false,
        isPro: <?php echo e($store->isPro() ? 'true' : 'false'); ?>,
        ...
        formData: {
            id: null,
            page_id: <?php echo e($defaultPage->id); ?>,
            type: '',
            title: '',
            url: '',
        ...
        refreshPreview() {
            ...
            this.previewKey++;
            this.previewUrl = '<?php echo e(url('/' . $store->username)); ?>' + '?preview=' + Date.now();
            setTimeout(() => { this.isRefreshing = false; }, 1000);
        },

        copyUrl() {
            navigator.clipboard.writeText('<?php echo e(url('/' . $store->username)); ?>').then(() => {
...
<?php echo $__env->make('layouts.seller', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\EtalaseKU\resources\views/seller/blocks/index.blade.php ENDPATH**/ ?>
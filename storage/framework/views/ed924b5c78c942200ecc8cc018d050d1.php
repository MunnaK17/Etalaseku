<?php $__env->startSection('title', 'Produk - EtalaseKu'); ?>
...
<div class="py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Kelola produk di etalase <?php echo e($store->name); ?></p>
        </div>
...
<div class="overflow-x-auto">
                                    ...
                                    <div class="flex items-center gap-3">
                                        <div class="flex-shrink-0 h-10 w-10 rounded-lg overflow-hidden bg-gray-100">
                                            <?php if($product->image): ?>
                                                <img class="h-full w-full object-cover" src="<?php echo e($product->image); ?>" alt="Gambar produk <?php echo e($product->name); ?>">
                                            <?php else: ?>
 ...
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-gray-500"><?php echo e(Str::limit($product->description, 40)); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-5 py-4 whitespace-nowrap">
                                    <span class="text-sm font-semibold text-gray-900"><?php echo e($product->formatted_price ?? '-'); ?></span>
                                </td>
                                <td class="px-5 py-4 whitespace-nowrap">
                                ...
                                <td class="px-5 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-50 text-indigo-700">
                                        <?php echo e(ucfirst(str_replace('_', ' ', $product->cta_type))); ?>
                                ...
                                <td class="px-5 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center justify-end gap-1">
                                        ...
                                        <form action="<?php echo e(route('seller.products.toggle-active', $product)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit"
                                                    class="p-2 <?php echo e($product->is_active ? 'text-gray-400 hover:text-yellow-600 hover:bg-yellow-50' : 'text-gray-400 hover:text-green-600 hover:bg-green-50'); ?> rounded-lg transition"
...
<?php echo $__env->make('layouts.seller', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\EtalaseKU\resources\views/seller/products/index.blade.php ENDPATH**/ ?>
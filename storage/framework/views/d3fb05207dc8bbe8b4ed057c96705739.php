<?php $__env->startSection('title', 'Appearance - EtalaseKu'); ?>
<?php $__env->startSection('breadcrumb', 'Appearance'); ?>
...
<div class="appearance-page">
    ...
    <div class="appearance-form-col">
        ...
        <div class="page-header">
            <div class="page-url">
                ...
                <span class="page-url-value">
                    <span><?php echo e(str_replace('http://', '', str_replace('https://', '', config('app.url')))); ?>/</span><?php echo e($store->username); ?>
        ...
        <form method="POST" action="<?php echo e(route('seller.appearance.update')); ?>" enctype="multipart/form-data" id="appearance-form">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PATCH'); ?>
            <input type="hidden" name="banner" id="banner-value" value="<?php echo e($store->banner); ?>">
            <input type="hidden" name="profile_image" id="profile-value" value="<?php echo e($store->profile_image); ?>">
            <input type="hidden" name="header_gradient_end" value="<?php echo e($store->header_gradient_end ?? '#4338CA'); ?>">
            <input type="hidden" name="background_gradient_start" value="<?php echo e($store->background_gradient_start ?? $store->header_gradient_start ?? '#4F46E5'); ?>">
            <input type="hidden" name="background_gradient_end" value="<?php echo e($store->background_gradient_end ?? $store->background_color ?? '#FFFFFF'); ?>">
            <input type="hidden" name="background_image" id="background-image-value" value="<?php echo e($store->background_image); ?>">
            ...
            <div class="section-card">
                ...
                <div class="visual-grid" style="grid-template-columns: repeat(3, 1fr);">
                    <label class="visual-card <?php echo e(($store->layout ?? 'modern') === 'classic' ? 'selected' : ''); ?>">
                        <input type="radio" name="layout" value="classic" <?php echo e(($store->layout ?? 'modern') === 'classic' ? 'checked' : ''); ?>>
                    ...
                    <label class="visual-card <?php echo e(($store->layout ?? 'modern') === 'modern' ? 'selected' : ''); ?>">
                        <input type="radio" name="layout" value="modern" <?php echo e(($store->layout ?? 'modern') === 'modern' ? 'checked' : ''); ?>>
                    ...
                    <label class="visual-card <?php echo e($store->layout === 'clean' ? 'selected' : ''); ?> <?php echo e(!$store->isPro() ? 'pro-locked' : ''); ?>">
                        <?php if(!$store->isPro()): ?>
                        ...
                        <?php endif; ?>
                        <input type="radio" name="layout" value="clean" <?php echo e($store->layout === 'clean' ? 'checked' : ''); ?>>
            ...
            <div class="section-card">
                ...
                <div class="upload-grid">
                    ...
                    <div>
                        ...
                        <div class="upload-area <?php echo e($store->banner ? 'has-image' : ''); ?>" id="banner-upload-area">
                            <?php if($store->banner): ?>
                                <img src="<?php echo e($store->banner); ?>" alt="Banner" id="banner-preview">
                            <?php else: ?>
                    ...
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <div class="profile-upload-circle <?php echo e($store->profile_image ? 'has-image' : ''); ?>" id="profile-upload-circle">
                            <?php if($store->profile_image): ?>
                                <img src="<?php echo e($store->profile_image); ?>" alt="Profile" id="profile-preview">
            ...
            <div class="section-card">
                ...
                <div class="textarea-wrapper">
                    <textarea name="about_text" rows="3" class="textarea-about" placeholder="I'm a Content Creator..."><?php echo e($store->about_text); ?></textarea>
            ...
            <div class="section-card">
                ...
                <div class="color-input-row">
                    <div class="color-swatch" style="background-color: <?php echo e($store->header_gradient_start ?? '#4F46E5'); ?>">
                        <input type="color" value="<?php echo e($store->header_gradient_start ?? '#4F46E5'); ?>" onchange="updatePrimaryColor(this)">
                    </div>
                    <input type="text" name="header_gradient_start" value="<?php echo e($store->header_gradient_start ?? '#4F46E5'); ?>" class="color-hex-input" onchange="syncColorSwatch(this)">
                </div>
            </div>
            ...
            <div class="section-card">
                ...
                <?php if($store->isPro()): ?>
                    ...
                    ?>
                    <?php $__currentLoopData = $socialFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <input type="hidden" name="social_<?php echo e($field); ?>" value="<?php echo e($store->{'social_' . $field} ?? ''); ?>">
                    ...
                    <div class="social-platforms">
                        ...
                        <?php $__currentLoopData = $socials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button type="button" class="social-pill <?php echo e($store->{'social_' . $social['key']} ? 'active' : ''); ?>" data-platform="<?php echo e($social['key']); ?>" onclick="toggleSocialPill(this)">
                                <?php echo $social['icon']; ?>

                                <?php echo e(ucfirst($social['key'])); ?>

                                <span class="social-remove" onclick="removeSocialLink(event, '<?php echo e($social['key']); ?>')" title="Hapus <?php echo e(ucfirst($social['key'])); ?>" aria-label="Hapus <?php echo e(ucfirst($social['key'])); ?>">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php else: ?>
                    <div class="text-center py-6">
                        ...
                        <a href="<?php echo e(route('seller.upgrade')); ?>" class="inline-flex items-center gap-2 mt-3 px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-sm font-semibold rounded-lg hover:from-purple-600 hover:to-pink-600 transition">
                            Upgrade Now
                        </a>
                    </div>
                <?php endif; ?>
            ...
            <div class="section-card">
                ...
                <div class="template-grid" id="template-grid">
                    ...
                    ?>
                    <?php $__currentLoopData = $templatePresets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $preset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        ?>
                        <label class="template-card <?php echo e($isSelected ? 'selected' : ''); ?> <?php echo e($cardClass); ?>"
                               data-template="<?php echo e($key); ?>"
                               data-bg-color="<?php echo e($preset['bg_color']); ?>"
                               data-bg-secondary="<?php echo e($preset['bg_secondary'] ?? ''); ?>"
                               data-bg-direction="<?php echo e($preset['bg_gradient_direction'] ?? ''); ?>"
                               data-btn-color="<?php echo e($preset['button_color']); ?>"
                               data-text-color="<?php echo e($preset['text_color']); ?>"
                               data-header-start="<?php echo e($preset['header_gradient_start']); ?>"
                               data-header-end="<?php echo e($preset['header_gradient_end']); ?>"
                               data-special="<?php echo e($preset['special_class'] ?? ''); ?>"
                               onclick="selectTemplate(this)">
                            <input type="radio" name="template" value="<?php echo e($key); ?>" <?php echo e($isSelected ? 'checked' : ''); ?>>
                            <div class="template-preview" style="<?php echo e($bgStyle); ?>">
                                <div class="template-header" style="<?php echo e($headerStyle); ?>;"></div>
                                <div class="template-content" <?php if($preset['bg_color'] !== '#FFFFFF' && $preset['bg_color'] !== '#f9fafc'): ?> style="background: rgba(255,255,255,0.9);" <?php endif; ?>>
                                    <div class="template-item" <?php if(isset($preset['card_bg']) && $preset['card_bg'] !== '#FFFFFF'): ?> style="background: <?php echo e($preset['card_bg']); ?>;" <?php endif; ?>></div>
                                    <div class="template-item" <?php if(isset($preset['card_bg']) && $preset['card_bg'] !== '#FFFFFF'): ?> style="background: <?php echo e($preset['card_bg']); ?>;" <?php endif; ?>></div>
                                    <div class="template-item" <?php if(isset($preset['card_bg']) && $preset['card_bg'] !== '#FFFFFF'): ?> style="background: <?php echo e($preset['card_bg']); ?>;" <?php endif; ?>></div>
                                </div>
                            </div>
                            <span class="template-name"><?php echo e($preset['name']); ?></span>
                            <?php if($isSelected): ?>
            ...
            <div class="section-card">
                ...
                <div class="mb-5">
                    ...
                    <div class="bg-type-grid">
                        <label class="bg-type-card <?php echo e(($store->background_type ?? 'flat') === 'flat' ? 'selected' : ''); ?>">
                            <input type="radio" name="background_type" value="flat" <?php echo e(($store->background_type ?? 'flat') === 'flat' ? 'checked' : ''); ?>>
                            <div class="bg-type-preview" style="background-color: <?php echo e($store->background_color ?? '#FFFFFF'); ?>;"></div>
                            <p class="bg-type-name">Flat Color</p>
                        </label>
                        <label class="bg-type-card <?php echo e($store->background_type === 'gradient_up' ? 'selected' : ''); ?> <?php echo e(!$store->isPro() ? 'pro-locked' : ''); ?>">
                            <?php if(!$store->isPro()): ?>
                                <span class="badge-pro" style="position: absolute; top: 6px; right: 6px; font-size: 8px; padding: 2px 5px;">PRO</span>
                            <?php endif; ?>
                            <input type="radio" name="background_type" value="gradient_up" <?php echo e($store->background_type === 'gradient_up' ? 'checked' : ''); ?>>
                            <div class="bg-type-preview" style="background: linear-gradient(180deg, <?php echo e($store->header_gradient_start ?? '#4F46E5'); ?>22, <?php echo e($store->background_color ?? '#FFFFFF'); ?>);"></div>
                            <p class="bg-type-name">Gradient Up</p>
                        </label>
                        <label class="bg-type-card <?php echo e($store->background_type === 'gradient_down' ? 'selected' : ''); ?> <?php echo e(!$store->isPro() ? 'pro-locked' : ''); ?>">
                            <?php if(!$store->isPro()): ?>
                                <span class="badge-pro" style="position: absolute; top: 6px; right: 6px; font-size: 8px; padding: 2px 5px;">PRO</span>
                            <?php endif; ?>
                            <input type="radio" name="background_type" value="gradient_down" <?php echo e($store->background_type === 'gradient_down' ? 'checked' : ''); ?>>
                            <div class="bg-type-preview" style="background: linear-gradient(0deg, <?php echo e($store->header_gradient_start ?? '#4F46E5'); ?>22, <?php echo e($store->background_color ?? '#FFFFFF'); ?>);"></div>
                            <p class="bg-type-name">Gradient Down</p>
                        </label>
                        <label class="bg-type-card <?php echo e($store->background_type === 'image' ? 'selected' : ''); ?> <?php echo e(!$store->isPro() ? 'pro-locked' : ''); ?>" onclick="openBackgroundImagePicker(event)">
                            <?php if(!$store->isPro()): ?>
                                <span class="badge-pro" style="position: absolute; top: 6px; right: 6px; font-size: 8px; padding: 2px 5px;">PRO</span>
                            <?php endif; ?>
                            <?php if($store->background_image): ?>
                            ...
                            <?php endif; ?>
                            <input type="radio" name="background_type" value="image" <?php echo e($store->background_type === 'image' ? 'checked' : ''); ?>>
                            <div id="background-image-preview" class="bg-type-preview bg-gray-100 flex items-center justify-center" <?php if($store->background_image): ?> style="background-image: url('<?php echo e($store->background_image); ?>'); background-size: cover; background-position: center;" <?php endif; ?>>
                                <?php if (! ($store->background_image)): ?>
                    ...
                    <div class="color-input-row" style="margin-top: 12px;">
                        <div class="color-swatch" style="background-color: <?php echo e($store->background_color ?? '#FFFFFF'); ?>;">
                            <input type="color" value="<?php echo e($store->background_color ?? '#FFFFFF'); ?>" onchange="updateBgColor(this)">
                        </div>
                        <input type="text" name="background_color" value="<?php echo e($store->background_color ?? '#FFFFFF'); ?>" class="color-hex-input" onchange="syncBgColorSwatch(this)">
                ...
                <div class="button-style-section">
                    ...
                    <?php if($store->isPro()): ?>
                        ...
                        <div class="style-grid">
                            <label class="style-card <?php echo e($store->cta_button_shape === 'sharp-hard' ? 'selected' : ''); ?>">
                                <input type="radio" name="cta_button_shape" value="sharp-hard" <?php echo e($store->cta_button_shape === 'sharp-hard' ? 'checked' : ''); ?>>
                                <div class="style-preview">
                                    <div class="style-btn-sample" style="border-radius: 0; box-shadow: 4px 4px 0 #1e293b; background: <?php echo e($store->cta_button_color ?? '#4F46E5'); ?>; color: <?php echo e($store->cta_button_text_color ?? '#FFF'); ?>;">CTA</div>
                                </div>
                                <p class="style-name">Square</p>
                            </label>
                            <label class="style-card <?php echo e(($store->cta_button_shape ?? 'rounded-hard') === 'rounded-hard' ? 'selected' : ''); ?>">
                                <input type="radio" name="cta_button_shape" value="rounded-hard" <?php echo e(($store->cta_button_shape ?? 'rounded-hard') === 'rounded-hard' ? 'checked' : ''); ?>>
                                <div class="style-preview">
                                    <div class="style-btn-sample" style="border-radius: 10px; box-shadow: 4px 4px 0 #1e293b; background: <?php echo e($store->cta_button_color ?? '#4F46E5'); ?>; color: <?php echo e($store->cta_button_text_color ?? '#FFF'); ?>;">CTA</div>
                                </div>
                                <p class="style-name">Rounded</p>
                            </label>
                            <label class="style-card <?php echo e($store->cta_button_shape === 'pill-hard' ? 'selected' : ''); ?>">
                                <input type="radio" name="cta_button_shape" value="pill-hard" <?php echo e($store->cta_button_shape === 'pill-hard' ? 'checked' : ''); ?>>
                                <div class="style-preview">
                                    <div class="style-btn-sample" style="border-radius: 50px; box-shadow: 4px 4px 0 #1e293b; background: <?php echo e($store->cta_button_color ?? '#4F46E5'); ?>; color: <?php echo e($store->cta_button_text_color ?? '#FFF'); ?>;">CTA</div>
                                </div>
                        ...
                        <div class="style-grid">
                            <label class="style-card <?php echo e($store->cta_button_shape === 'square-soft' ? 'selected' : ''); ?>">
                                <input type="radio" name="cta_button_shape" value="square-soft" <?php echo e($store->cta_button_shape === 'square-soft' ? 'checked' : ''); ?>>
                                <div class="style-preview">
                                    <div class="style-btn-sample" style="border-radius: 0; box-shadow: 0 4px 14px rgba(0,0,0,0.2); background: <?php echo e($store->cta_button_color ?? '#4F46E5'); ?>; color: <?php echo e($store->cta_button_text_color ?? '#FFF'); ?>;">CTA</div>
                                </div>
                                <p class="style-name">Square</p>
                            </label>
                            <label class="style-card <?php echo e($store->cta_button_shape === 'rounded-soft' ? 'selected' : ''); ?>">
                                <input type="radio" name="cta_button_shape" value="rounded-soft" <?php echo e($store->cta_button_shape === 'rounded-soft' ? 'checked' : ''); ?>>
                                <div class="style-preview">
                                    <div class="style-btn-sample" style="border-radius: 10px; box-shadow: 0 4px 14px rgba(0,0,0,0.2); background: <?php echo e($store->cta_button_color ?? '#4F46E5'); ?>; color: <?php echo e($store->cta_button_text_color ?? '#FFF'); ?>;">CTA</div>
                                </div>
                                <p class="style-name">Rounded</p>
                            </label>
                            <label class="style-card <?php echo e($store->cta_button_shape === 'rainbow' ? 'selected' : ''); ?>">
                                <input type="radio" name="cta_button_shape" value="rainbow" <?php echo e($store->cta_button_shape === 'rainbow' ? 'checked' : ''); ?>>
                                <div class="style-preview">
                                    <div class="style-btn-sample" style="border-radius: 10px; background: linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #0000ff, #8b00ff); padding: 2px;">
                                        <span style="background: <?php echo e($store->cta_button_color ?? '#4F46E5'); ?>; display: block; border-radius: 8px; color: <?php echo e($store->cta_button_text_color ?? '#FFF'); ?>;">CTA</span>
                                    </div>
                                </div>
                        ...
                        <div class="style-grid">
                            <label class="style-card <?php echo e($store->cta_button_shape === 'bracket' ? 'selected' : ''); ?>">
                                <input type="radio" name="cta_button_shape" value="bracket" <?php echo e($store->cta_button_shape === 'bracket' ? 'checked' : ''); ?>>
                                <div class="style-preview">
                                    <div class="style-btn-sample" style="background: <?php echo e($store->cta_button_color ?? '#4F46E5'); ?>; color: <?php echo e($store->cta_button_text_color ?? '#FFF'); ?>;">
                                        <span style="opacity: 0.5;">&lt;</span>CTA<span style="opacity: 0.5;">&gt;</span>
                                    </div>
                                </div>
                                <p class="style-name">Bracket</p>
                            </label>
                            <label class="style-card <?php echo e($store->cta_button_shape === 'scribble' ? 'selected' : ''); ?>">
                                <input type="radio" name="cta_button_shape" value="scribble" <?php echo e($store->cta_button_shape === 'scribble' ? 'checked' : ''); ?>>
                                <div class="style-preview">
                                    <div class="style-btn-sample" style="background: <?php echo e($store->cta_button_color ?? '#4F46E5'); ?>; color: <?php echo e($store->cta_button_text_color ?? '#FFF'); ?>; position: relative;">
                                        CTA
                        ...
                        <div class="cta-colors-grid" style="margin-top: 16px;">
                            <div class="cta-color-item">
                                ...
                                <div class="cta-color-input">
                                    <div class="cta-color-swatch" style="background-color: <?php echo e($store->cta_button_color ?? '#4F46E5'); ?>;">
                                        <input type="color" value="<?php echo e($store->cta_button_color ?? '#4F46E5'); ?>" oninput="updateCtaColor(this)" onchange="updateCtaColor(this)">
                                    </div>
                                    <input type="text" name="cta_button_color" value="<?php echo e($store->cta_button_color ?? '#4F46E5'); ?>" class="cta-color-hex" oninput="syncCtaColorText(this)">
                                </div>
                            </div>
                            <div class="cta-color-item">
                                <label>Text Color</label>
                                <div class="cta-color-input">
                                    <div class="cta-color-swatch" style="background-color: <?php echo e($store->cta_button_text_color ?? '#FFFFFF'); ?>;">
                                        <input type="color" value="<?php echo e($store->cta_button_text_color ?? '#FFFFFF'); ?>" oninput="updateCtaTextColor(this)" onchange="updateCtaTextColor(this)">
                                    </div>
                                    <input type="text" name="cta_button_text_color" value="<?php echo e($store->cta_button_text_color ?? '#FFFFFF'); ?>" class="cta-color-hex" oninput="syncCtaTextColorText(this)">
                                </div>
                            </div>
                        </div>
                    <?php else: ?>
            ...
            <div class="section-card">
                ...
                <div class="font-grid">
                    ...
                    ?>
                    <?php $__currentLoopData = $fontList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $font): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="font-card <?php echo e(($store->font_family ?? 'Inter') === $font['key'] ? 'selected' : ''); ?>" style="font-family: <?php echo e($font['family']); ?>;">
                            <input type="radio" name="font_family" value="<?php echo e($font['key']); ?>" <?php echo e(($store->font_family ?? 'Inter') === $font['key'] ? 'checked' : ''); ?>>
                            <div class="font-preview">Aa</div>
                            <div class="font-name"><?php echo e($font['name']); ?></div>
                        </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
                ...
                <?php if($store->isPro()): ?>
                    <div class="mb-4">
                        ...
                        <div class="style-grid" style="grid-template-columns: 1fr 1fr;">
                            <label class="style-card <?php echo e(($store->cta_button_style ?? 'fill') === 'fill' ? 'selected' : ''); ?>">
                                <input type="radio" name="cta_button_style" value="fill" <?php echo e(($store->cta_button_style ?? 'fill') === 'fill' ? 'checked' : ''); ?>>
                                <div class="style-preview">
                                    <div class="style-btn-sample" style="background: <?php echo e($store->cta_button_color ?? '#4F46E5'); ?>; color: <?php echo e($store->cta_button_text_color ?? '#FFF'); ?>; border: none;">Fill Color</div>
                                </div>
                                <p class="style-name">Fill Color</p>
                            </label>
                            <label class="style-card <?php echo e($store->cta_button_style === 'outline' ? 'selected' : ''); ?>">
                                <input type="radio" name="cta_button_style" value="outline" <?php echo e($store->cta_button_style === 'outline' ? 'checked' : ''); ?>>
                                <div class="style-preview">
                                    <div class="style-btn-sample" style="background: transparent; color: <?php echo e($store->cta_button_color ?? '#4F46E5'); ?>; border: 2px solid <?php echo e($store->cta_button_color ?? '#4F46E5'); ?>;">Outline</div>
                                </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="style-grid">
                            <label class="style-card <?php echo e(($store->cta_button_shape ?? 'rounded') === 'rounded' ? 'selected' : ''); ?>">
                                <input type="radio" name="cta_button_shape" value="rounded" <?php echo e(($store->cta_button_shape ?? 'rounded') === 'rounded' ? 'checked' : ''); ?>>
                                <div class="style-preview">
                                    <div class="style-btn-sample" style="border-radius: 10px; background: <?php echo e($store->cta_button_color ?? '#4F46E5'); ?>; color: <?php echo e($store->cta_button_text_color ?? '#FFF'); ?>; box-shadow: 0 4px 14px rgba(0,0,0,0.15);">CTA</div>
                                </div>
                                <p class="style-name">Rounded</p>
                            </label>
                            <label class="style-card <?php echo e(($store->cta_button_shape ?? '') === 'sharp' ? 'selected' : ''); ?>">
                                <input type="radio" name="cta_button_shape" value="sharp" <?php echo e(($store->cta_button_shape ?? '') === 'sharp' ? 'checked' : ''); ?>>
                                <div class="style-preview">
                                    <div class="style-btn-sample" style="border-radius: 4px; background: <?php echo e($store->cta_button_color ?? '#4F46E5'); ?>; color: <?php echo e($store->cta_button_text_color ?? '#FFF'); ?>; box-shadow: 0 4px 14px rgba(0,0,0,0.15);">CTA</div>
                                </div>
                                <p class="style-name">Square</p>
                            </label>
                            <label class="style-card <?php echo e(($store->cta_button_shape ?? '') === 'pill' ? 'selected' : ''); ?>">
                                <input type="radio" name="cta_button_shape" value="pill" <?php echo e(($store->cta_button_shape ?? '') === 'pill' ? 'checked' : ''); ?>>
                                <div class="style-preview">
                                    <div class="style-btn-sample" style="border-radius: 50px; background: <?php echo e($store->cta_button_color ?? '#4F46E5'); ?>; color: <?php echo e($store->cta_button_text_color ?? '#FFF'); ?>; box-shadow: 0 4px 14px rgba(0,0,0,0.15);">CTA</div>
                                </div>
                                <p class="style-name">Pill</p>
                            </label>
                        </div>
                    ...
                    <div class="toggle-row" style="padding-top: 0;">
                        ...
                        <div class="toggle-switch <?php echo e($store->cta_button_shadow ? 'active' : ''); ?>" onclick="toggleSoftShadow(this)">
                            <input type="hidden" name="cta_button_shadow" value="<?php echo e($store->cta_button_shadow ? 1 : 0); ?>">
                        </div>
                    </div>
                <?php else: ?>
                    <div class="text-center py-6">
        ...
        <div class="appearance-preview-card">
            ...
            <div class="appearance-preview-frame">
                <iframe
                    ...
                    src="<?php echo e($store->public_url); ?>?preview=1&_=<?php echo e(time()); ?>"
...
<script>
    ...
    const previewUrl = '<?php echo e(route("seller.appearance.preview-save")); ?>';
    const storeUrl = '<?php echo e($store->public_url); ?>';
    ...
    // Copy link function
    function copyLink() {
        navigator.clipboard.writeText('<?php echo e($store->public_url); ?>').then(() => {
...
<?php echo $__env->make('layouts.seller', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\EtalaseKU\resources\views/seller/appearance/index.blade.php ENDPATH**/ ?>
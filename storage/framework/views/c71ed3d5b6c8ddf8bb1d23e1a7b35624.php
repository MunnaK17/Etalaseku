        ...
        <main class="flex flex-1 flex-col items-center px-6 lg:flex-row lg:px-12">
            <section class="hidden items-center justify-center py-4 lg:flex lg:w-[55%]" aria-label="Ilustrasi register">
                <div class="flex max-h-[78vh] max-w-full items-center justify-center overflow-hidden rounded-2xl shadow-lg" style="background: var(--illustration-bg); aspect-ratio: 4 / 3">
                    <img src="<?php echo e(asset('images/register.png')); ?>" alt="Ilustrasi ekosistem inklusif EtalaseKu untuk registrasi" class="h-full w-full object-contain">
                </div>
            </section>
            ...
            <section class="flex w-full items-center justify-center py-8 lg:w-[45%] lg:py-0" aria-label="Form register">
                <div class="w-full max-w-[420px]">
                    ...
                    <p class="mb-8 mt-2 text-sm" style="color: var(--text-muted);">
                        Sudah punya akun?
                        <a href="<?php echo e($loginUrl); ?>" class="font-semibold transition hover:opacity-80 focus-visible:outline-none focus-visible:ring-2" style="color: var(--accent); --tw-ring-color: var(--accent);">
                            Masuk di sini
                        </a>
                    </p>

                    <form method="POST" action="<?php echo e($registerAction); ?>" class="space-y-5">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <label class="flex cursor-pointer select-none items-start gap-2">
                            <input
                                ...
                                value="1"
                                required
                                <?php if(old('agree')): echo 'checked'; endif; ?>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="-mt-3 text-sm" style="color: var(--error);"><?php echo e($message); ?></p>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php /**PATH C:\laragon\www\EtalaseKU\resources\views/auth/register.blade.php ENDPATH**/ ?>
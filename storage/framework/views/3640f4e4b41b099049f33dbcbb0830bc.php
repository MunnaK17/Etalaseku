<?php $__env->startSection('title', 'Verifikasi Seller - EtalaseKu'); ?>
<?php $__env->startSection('breadcrumb', 'Verifikasi Seller'); ?>
...
<div class="py-6">
    <div class="verification-container">
            ...
            <div class="status-card-inner">
                <?php if($store->is_verified_seller): ?>
                    ...
                    <div class="status-content">
                        ...
                        <?php if($store->verified_at): ?>
                            <p class="status-meta">Diverifikasi pada: <?php echo e($store->verified_at->format('d F Y, H:i')); ?></p>
                        <?php endif; ?>
                    </div>
                <?php elseif($verification && $verification->isPending): ?>
                    ...
                    <div class="status-content">
                        ...
                        <p class="status-meta">Submitted: <?php echo e($verification->submitted_at->format('d F Y, H:i')); ?></p>
                    </div>
                    <form action="<?php echo e(route('seller.verification.destroy', $verification)); ?>" method="POST" onsubmit="return confirm('Yakin ingin membatalkan verifikasi?');">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="status-content">
                        ...
                        <?php if($verification->admin_notes): ?>
                            <div class="rejection-box">
                                ...
                                <p class="rejection-box-text"><?php echo e($verification->admin_notes); ?></p>
                            </div>
                        <?php endif; ?>
                    </div>
                <?php else: ?>
        ...
        <?php if($store->is_verified_seller || ($verification && ($verification->isPending || $verification->isRejected && !$verification->isPending && !$store->is_verified_seller && $verification->status === 'rejected'))): ?>
            <?php if($verification && $verification->isRejected && !$verification->isPending && !$store->is_verified_seller): ?>
        ...
        <!-- Upload Form -->
        <?php if(!$store->is_verified_seller && (!$verification || $verification->isRejected)): ?>
                        ...
                        <div class="form-grid">
                            <div>
                                ...
                                <input type="text" id="nik" name="nik" value="<?php echo e(old('nik')); ?>"
                                       class="form-input <?php $__errorArgs = ['nik'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" id="full_name" name="full_name" value="<?php echo e(old('full_name', $store->user->name ?? '')); ?>"
                    ...
                    <div class="section-card">
                        ...
                        <div class="form-grid-3">
                            <div>
                                ...
                                <input type="text" id="business_name" name="business_name" value="<?php echo e(old('business_name', $store->name)); ?>"
                                       class="form-input"
                            ...
                            <div>
                                ...
                                <select id="business_type" name="business_type" class="form-select">
                                    ...
                                    <option value="personal" <?php echo e(old('business_type') === 'personal' ? 'selected' : ''); ?>>Personal / Perorangan</option>
                                    <option value="company" <?php echo e(old('business_type') === 'company' ? 'selected' : ''); ?>>Perusahaan</option>
                                    <option value="cooperative" <?php echo e(old('business_type') === 'cooperative' ? 'selected' : ''); ?>>Koperasi</option>
                                </select>
                            </div>
                            <div>
                                <label for="nib_number" class="form-label">Nomor NIB</label>
                                <input type="text" id="nib_number" name="nib_number" value="<?php echo e(old('nib_number')); ?>"
                                       class="form-input"
                    ...
                    <div class="section-card">
                        ...
                        <div class="upload-grid">
                            ...
                            <div>
                                ...
                                <div class="upload-area <?php echo e(old('ktp_file') ? 'has-file' : ''); ?>" id="ktp-upload-area"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="upload-area <?php echo e(old('npwp_file') ? 'has-file' : ''); ?>" id="npwp-upload-area"
                                     onclick="document.getElementById('npwp_file').click()">
                                    <?php if(old('npwp_file')): ?>
                                        <p class="file-name">File selected</p>
                                    <?php else: ?>
                                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="upload-area <?php echo e(old('siu_file') ? 'has-file' : ''); ?>" id="siu-upload-area"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="upload-area <?php echo e(old('selfie_file') ? 'has-file' : ''); ?>" id="selfie-upload-area"
                                     onclick="document.getElementById('selfie_file').click()">
                                    <?php if(old('selfie_file')): ?>
                                        <p class="file-name">File selected</p>
                                    <?php else: ?>
                                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.seller', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\EtalaseKU\resources\views/seller/verification/index.blade.php ENDPATH**/ ?>
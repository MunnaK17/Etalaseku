...
<head>
    ...
    <title>Pembayaran - <?php echo e($order->product->name); ?> - EtalaseKu</title>
    ...
    <div class="max-w-lg mx-auto bg-white min-h-screen shadow-xl">
        ...
        <header class="bg-gradient-to-br from-primary-600 to-primary-700 text-white px-5 pt-8 pb-6">
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('public.store', $order->store->username)); ?>" class="p-2 rounded-lg bg-white/20 hover:bg-white/30 transition">
                ...
                <div>
                    ...
                    <p class="text-primary-100 text-sm">Order: <?php echo e($order->order_number); ?></p>
                </div>
            </div>
        </header>
                ...
                <div class="p-5">
                    ...
                    <div class="flex gap-4 mb-4">
                        <?php if($order->product->image): ?>
                            <img src="<?php echo e($order->product->image); ?>" alt="<?php echo e($order->product->name); ?>" class="w-20 h-20 rounded-xl object-cover flex-shrink-0">
                        <?php else: ?>
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500"><?php echo e($order->product->description); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-200 mt-4 pt-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-2xl font-bold text-primary-600"><?php echo e($order->formatted_amount); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    document.getElementById('pay-button').addEventListener('click', function() {
                        snap.pay('<?php echo e($snapToken); ?>', {
                            onSuccess: function(result) {
                                window.location.href = '<?php echo e(route('checkout.success', $order->order_number)); ?>?status=success';
                            },
                            onPending: function(result) {
                                window.location.href = '<?php echo e(route('checkout.success', $order->order_number)); ?>?status=pending';
                            },
                            onError: function(result) {
                                window.location.href = '<?php echo e(route('checkout.success', $order->order_number)); ?>?status=error';
                            },
                            onClose: function() {
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-6">
                    ...
                    <div class="p-5">
                        ...
                        <?php if($order->store->whatsapp): ?>
                            <a href="<?php echo e($order->store->whatsapp_link_with_message); ?>?text=<?php echo e(urlencode('Halo, saya ingin konfirmasi pembayaran untuk pesanan ' . $order->order_number . ' seharga ' . $order->formatted_amount)); ?>"
                               target="_blank"
...
</html><?php /**PATH C:\laragon\www\EtalaseKU\resources\views/checkout/payment.blade.php ENDPATH**/ ?>
    ...
    <div class="flex min-h-screen flex-col">
        ...
        <main class="flex flex-1 flex-col items-center px-6 lg:flex-row lg:px-12">
            <section class="hidden items-center justify-center py-4 lg:flex lg:w-[55%]" aria-label="Ilustrasi register">
                <div class="flex max-h-[78vh] max-w-full items-center justify-center overflow-hidden rounded-2xl bg-[#f8f3ea] shadow-lg" style="aspect-ratio: 4 / 3">
                    <img src="/images/register.png" alt="Ilustrasi ekosistem inklusif EtalaseKu untuk registrasi" class="h-full w-full object-contain">
                </div>
            </section>
            ...
            <section class="flex w-full items-center justify-center py-8 lg:w-[45%] lg:py-0" aria-label="Form register">
                <div class="w-full max-w-[420px]">
                    ...
                    <p class="mb-8 mt-2 text-sm text-zinc-400">
                        Sudah punya akun?
                        <a href="{{ $loginUrl }}" class="font-semibold text-yellow-400 transition hover:text-yellow-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-400/50">
                            Masuk di sini
                        </a>
                    </p>
                    ...
                    <form method="POST" action="{{ $registerAction }}" class="space-y-5">
                        ...
                        <label class="flex cursor-pointer select-none items-start gap-2">
                            ...
                            >
                            <span class="text-sm leading-snug text-zinc-400">
                                Saya menyetujui
                                <a href="#" class="font-medium text-yellow-400 transition hover:text-yellow-300">Syarat &amp; Ketentuan</a>
                                dan
                                <a href="#" class="font-medium text-yellow-400 transition hover:text-yellow-300">Kebijakan Privasi</a>
                            </span>
                        </label>
                        @error('agree')
                        ...
                        <button id="registerButton" type="submit" class="inline-flex w-full items-center justify-center rounded-lg bg-yellow-400 px-4 py-2.5 text-sm font-semibold text-black transition hover:bg-yellow-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-400/50 disabled:cursor-not-allowed disabled:opacity-50">
                            Daftar Gratis
                        </button>
                    </form>

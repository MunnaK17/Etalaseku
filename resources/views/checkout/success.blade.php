...
<div class="bg-gradient-to-br from-{{ $msg['color'] }}-500 to-{{ $msg['color'] }}-600 text-white px-5 pt-12 pb-16 text-center">
    ...
    <h1 class="text-2xl font-bold">{{ $msg['title'] }}</h1>
    <p class="text-{{ $msg['color'] }}-100 mt-2">{{ $msg['subtitle'] }}</p>
</div>

        <!-- Wave -->
<svg class="w-full h-8 -mt-4 text-{{ $msg['color'] }}-500" viewBox="0 0 1200 120" preserveAspectRatio="none">
                ...
                <div class="p-5 space-y-4">
                    ...
                    <div class="flex gap-4">
                        @if($order->product->image)
                            <img src="{{ $order->product->image }}" alt="{{ $order->product->name }}" class="w-16 h-16 rounded-xl object-cover flex-shrink-0">
                        @else
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-lg font-bold text-primary-600 mt-1">{{ $order->formatted_amount }}</p>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-100 pt-4 space-y-3">
                        ...
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="inline-flex px-2 py-0.5 rounded-full text-xs font-semibold {{ $order->payment_status_badge_class }}">

    ...
    <div class="min-h-screen">
        ...
        <header class="px-6 py-4 lg:px-12">
            <div class="mx-auto flex max-w-6xl items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('home') }}" class="inline-flex items-center gap-1.5 rounded-md px-3 py-2 text-sm transition" style="color: var(--text-muted);">
        ...
        <main class="px-6 py-8 lg:px-12">
            <div class="mx-auto max-w-3xl">
                ...
                <div class="rounded-3xl border p-8 sm:p-10" style="background: var(--bg-card); border-color: var(--border-color); backdrop-filter: blur(10px);">
                    ...
                    <form action="{{ route('inclusive-program.submit') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <select id="disability_type" name="disability_type" required
                                        class="form-input @error('disability_type') border-red-500 @enderror">
                                    ...
                                    <option value="mental" {{ old('disability_type') === 'mental' ? 'selected' : '' }}>Disabilitas Mental / Psikososial</option>
                        ...
                        <div>
                            ...
                            <textarea id="reason" name="reason" required
                                      ...
                                      placeholder="Ceritakan bagaimana EtalaseKu dapat membantu usaha atau pekerjaan Anda... (minimal 50 karakter)">{{ old('reason') }}</textarea>
                            @error('reason')
                                <p class="form-error">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="expected_benefits" name="expected_benefits"
                                      class="form-input @error('expected_benefits') border-red-500 @enderror"
        ...
        <footer class="mt-12 border-t px-6 py-6 lg:px-12" style="border-color: var(--border-color);">
            <div class="mx-auto max-w-6xl text-center text-sm" style="color: var(--text-muted);">
                <p>&copy; {{ date('Y') }} EtalaseKu. Semua hak dilindungi.</p>
            </div>
        </footer>
    </div>

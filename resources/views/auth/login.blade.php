    ...
    <div class="space-y-5">
        ...
        <div class="mb-6">
            ...
            <p class="text-[#cfc3cc] text-base">
                Belum punya akun? <a class="text-[#e2bae2] hover:underline font-bold transition-all" href="{{ route('register') }}">Daftar di sini</a>
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <div class="flex items-center justify-between pt-2">
                ...
                @if (Route::has('password.request'))
                    <a class="text-sm text-[#e2bae2] hover:text-[#d0a9d0] transition-colors font-semibold" href="{{ route('password.request') }}">
                        Lupa password?
                    </a>
                @endif
            </div>

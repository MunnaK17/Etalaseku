...
@section('title', 'Wallet - EtalaseKu')
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl p-6 text-white">
                ...
                <p class="text-3xl font-bold mb-1">{{ $wallet->formatted_balance }}</p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                ...
                <p class="text-2xl font-bold text-gray-900 mb-1">Rp {{ number_format($pendingWithdrawals, 0, ',', '.') }}</p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                ...
                <p class="text-2xl font-bold text-green-600 mb-1">Rp {{ number_format($availableBalance, 0, ',', '.') }}</p>
        ...
        @if($availableBalance >= 10000)
            <div class="mb-6">
                <a href="{{ route('seller.wallet.withdraw.form') }}"
        ...
        @elseif($availableBalance > 0 && $availableBalance < 10000)
            <div class="mb-6 bg-yellow-50 border border-yellow-200 rounded-xl p-4">
                <p class="text-yellow-800 text-sm">
                    ...
                    Minimum penarikan adalah Rp 10.000. Saldo available kamu sekarang: Rp {{ number_format($availableBalance, 0, ',', '.') }}
                </p>
            </div>
        @endif
                            ...
                            @foreach($transactions as $transaction)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $transaction->type_badge_class }}">

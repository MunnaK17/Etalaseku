    ...
    <div class="wallet-container">
        ...
        <div class="balance-cards">
            ...
            <div class="balance-card balance-card-main">
                ...
                <p class="balance-card-amount">{{ $wallet->formatted_balance }}</p>
            ...
            <div class="balance-card balance-card-pending">
                ...
                <p class="balance-card-amount">Rp {{ number_format($pendingWithdrawals, 0, ',', '.') }}</p>
            ...
            <div class="balance-card balance-card-available">
                ...
                <p class="balance-card-amount">Rp {{ number_format($availableBalance, 0, ',', '.') }}</p>
        ...
        @if($availableBalance >= 10000)
            <a href="{{ route('seller.wallet.withdraw.form') }}" class="withdraw-btn">
        ...
        @elseif($availableBalance > 0 && $availableBalance < 10000)
            <div class="wallet-warning">
                ...
                <p>Minimum penarikan adalah Rp 10.000. Saldo available kamu sekarang: Rp {{ number_format($availableBalance, 0, ',', '.') }}</p>
            </div>
        @endif
                        ...
                        <tbody>
                            @foreach($transactions as $transaction)
                                <tr>
                                    ...
                                    <td>
                                        <span class="type-badge type-badge-{{ $transaction->type }}">
                                    ...
                                    <td>
                                        @if($transaction->reference_id)
                                            <span class="ref-mono">#{{ $transaction->reference_id }}</span>
                                        @else
                                            -
                                        @endif
                                    </td>
